...
Return a JSON object with EXACTLY these keys:
{
  ...
  "overview": "Drug class, mechanism of action, clinical role and main indications. 2-3 paragraphs. REQUIRED STRUCTURE:\n\n1. Simple mechanism callout: Include on its own line — '> ⚡ **Mechanism:** [one concise sentence]'\n\n2. Detailed MOA (expandable): Immediately after, include this HTML block (keep exact format, markdown renderer will preserve it):\n<details>\n<summary>▾ Detailed mechanism of action</summary>\n[3-5 detailed paragraphs covering molecular targets, signaling cascades, key tissue effects, any feedback loops, clinical relevance of mechanism]\n</details>\n\n3. Warning callouts (if needed): Include '> ⚠️ **Note:** [important note]' or '> 🚨 **Warning:** [serious warning]' as separate blockquotes within the overview text.\n\nDo NOT put the detailed MOA in the blockquote — it must be in the <details> element.",
